...
<!--For update schedule-->
<div class="modal fade" id="modal-update-schedule" tabindex="-1" role="dialog" aria-labelledby="modal-register"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{route('doc.updateschedule')}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <select type="text" name="days" id="days">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="from" class="form-control" id="from"
                            aria-describedby="emailHelp" placeholder="Start Time" value="10:00">

                    </div>

                    <div class="form-group">
                        <label for="to">To</label>
                        <input type="time" name="to" class="form-control" id="to" aria-describedby="emailHelp"
                            placeholder="Close Time" value="10:00">
                    </div>
                    <button type="submit" class="btn btn-primary">Submit</button>
                </form>
            </div>
