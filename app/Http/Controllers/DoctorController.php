...
class DoctorController extends Controller
{
    public function home()
    {
        if (isset(Auth::user()->role) and Auth::user()->role == 'doctor') {
            ...
            $updateschedule = Updateschedule::orderBy('created_at','asc')->get();
            view()->share('updateschedule', $updateschedule);
    ...
    public function updateschedule(Request $request)
    {
        ...
        $updateschedule->days = $request->days;
        $updateschedule->from = $request->from;
        $updateschedule->to = $request->to;
